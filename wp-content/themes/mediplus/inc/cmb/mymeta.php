...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo = new_cmb2_box( array(
		...
		'title'         => esc_html__( 'Other Features', 'cmb2' ),
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Class Name', 'sablu_hasan' ),
		'desc'       => esc_html__( 'Icon Class', 'sablu_hasan' ),
		'id'         => 'iconclass',
		'type'       => 'text',
	) );

	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Booking URL', 'sablu_hasan' ),
		'desc'       => esc_html__( 'Add Booking URL', 'sablu_hasan' ),
		'id'         => 'bookingurl',
		'type'       => 'text_url',
	) );
	
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Booking Price', 'sablu_hasan' ),
		'desc'       => esc_html__( 'Add Booking Price', 'sablu_hasan' ),
		'id'         => 'package_price',
		'type'       => 'text',
	) );
...
function yourprefix_register_repeatable_group_field_metabox() {
	...
	$group_field_id = $cmb_group->add_field( array(
		...
		'options'     => array(
			'group_title'    => esc_html__( 'Feature {#}', 'cmb2' ), // {#} gets replaced by row number
			'add_button'     => esc_html__( 'Add Another Feature', 'cmb2' ),
			'remove_button'  => esc_html__( 'Remove Feature', 'cmb2' ),
			'sortable'       => true,
