    ...
    <body>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="index.html"><img src="<?php echo get_parent_theme_file_uri( 'assets/img/logo.png' ); ?>" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
		...
		<section class="slider">
			<div class="hero-slider">
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('<?php echo get_parent_theme_file_uri( 'assets/img/slider2.jpg' ); ?>')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<!-- End Single Slider -->
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('<?php echo get_parent_theme_file_uri( 'assets/img/slider.jpg' ); ?>')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<!-- Start End Slider -->
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('<?php echo get_parent_theme_file_uri( 'assets/img/slider3.jpg' ); ?>')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							...
							<img src="<?php echo get_parent_theme_file_uri( 'assets/img/section-img.png' ); ?>" alt="#">
				...
				<div class="row">
					<div class="col-lg-12 col-12">
						<div class="owl-carousel portfolio-slider">
							<div class="single-pf">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/pf1.jpg' ); ?>" alt="#">
								<a href="portfolio-details.html" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/pf2.jpg' ); ?>" alt="#">
								<a href="portfolio-details.html" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/pf3.jpg' ); ?>" alt="#">
								<a href="portfolio-details.html" class="btn">View Details</a>
							</div>
							<div class="single-pf">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/pf4.jpg' ); ?>" alt="#">
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/blog1.jpg' ); ?>" alt="#">
							</div>
							<div class="news-body">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/blog2.jpg' ); ?>" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/blog3.jpg' ); ?>" alt="#">
							</div>
							<div class="news-body">
								<div class="news-content">
					...
					<div class="col-lg-12 col-md-12 col-12">
						<div class="owl-carousel clients-slider">
							<div class="single-clients">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/client1.png' ); ?>" alt="#">
							</div>
							<div class="single-clients">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/client2.png' ); ?>" alt="#">
							</div>
							<div class="single-clients">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/client3.png' ); ?>" alt="#">
							</div>
							<div class="single-clients">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/client4.png' ); ?>" alt="#">
							</div>
							<div class="single-clients">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/client5.png' ); ?>" alt="#">
							</div>
							<div class="single-clients">
								<img src="<?php echo get_parent_theme_file_uri( 'assets/img/client1.png' ); ?>" alt="#">
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 ">
						<div class="appointment-image">
							<img src="<?php echo get_parent_theme_file_uri( 'assets/img/contact-img.png' ); ?>" alt="#">
						</div>
					</div>
				</div>
			</div>
